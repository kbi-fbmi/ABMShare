...
new_result_flows = [f"new_{key}" for key in result_flows]
cum_result_flows = [f"cum_{key}" for key in result_flows]
new_result_flows_by_variant = [f"new_{key}" for key in result_flows_by_variant]
cum_result_flows_by_variant = [f"cum_{key}" for key in result_flows_by_variant]
