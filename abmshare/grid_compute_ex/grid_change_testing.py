...
class Grid_change_path:
    def __init__(self,wait:bool=False,current_dir:str=None):
        ...
        # Getters
        self.current_directory_name=current_dir or self.get_current_directory()
...
if __name__=="__main__":
    os.environ['SCRATCHDIR']="/home/user/sandbox"
    Grid_change_path(current_dir="/storage/ssd2/sharesim/share-covasim/extensions/grid_compute_ex/testing_grid/")
    print()