...
class Sim(cvb.BaseSim):
    ...
    **Examples**::
    ...
    def __init__(self, pars=None, datafile=None, label=None, simfile=None,
                 popfile=None, people=None, version=None,location_code:str=None,
                 region_parent_name:str=None, **kwargs):
        ...
        self.location_code = location_code # Only for info added above original covasim
        self.region_parent_name = region_parent_name # Only for info added above original covasim
    ...
    def initialize(self, reset=False, init_infections=True, **kwargs):
        ...
        self.init_variants() # Initialize the variants #TODO: append to dictionary
        self.init_immunity() # initialize information about immunity (if use_waning=True) #TODO: append to dictionary
    ...
    def run(self, do_plot=False, until=None, restore_pars=True, reset_seed=True, verbose=None):
        ...
        while self.t < until:
            ...
            if self["timelimit"] and elapsed > self["timelimit"]:
                ...
                return None
            if self["stopping_func"] and self["stopping_func"](self):
